...
submit_button = Button(main_window, text="Submit info", command=submit, height=3, width=16)
...
delete_button = Button(main_window, text="Delete info", command=delete, height=3, width=16)
