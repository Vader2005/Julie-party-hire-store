...
delete_button = Button(main_window, text="Delete info", command=delete, height=3, width=8).place(x=400, y=80)

# Create the Terms and conditions button
Terms = Button(main_window, text="Read Terms", height=3, width=8, command=Terms).place(x=500, y=80)
